...
applying the HypI infill criterion
...
# FUNCTION_NAME = "ZDT1"; d1Reference = [1.1, 100.0]
# FUNCTION_NAME = "ZDT2"; d1Reference = [1.1, 100.0]
# FUNCTION_NAME = "ZDT3"; d1Reference = [1.1, 100.0]
# FUNCTION_NAME = "ZDT4"; d1Reference = [1.1, 100.0]
# FUNCTION_NAME = "ZDT6"; d1Reference = [1.1, 100.0]
# FUNCTION_NAME = "DTLZ1"; d1Reference = np.repeat(100.0, NUM_OBJECTIVES).tolist()
# FUNCTION_NAME = "DTLZ2"; d1Reference = np.repeat(100.0, NUM_OBJECTIVES).tolist()
# FUNCTION_NAME = "DTLZ3"; d1Reference = np.repeat(100.0, NUM_OBJECTIVES).tolist()
# FUNCTION_NAME = "DTLZ4"; d1Reference = np.repeat(100.0, NUM_OBJECTIVES).tolist()
FUNCTION_NAME = "DTLZ7"; d1Reference = [1.1, 100.0]
...
OUTPUT_FOLDER = os.path.join("Results_Detailed_HypI_Timed", 
...
def run(ITERATION):
    ...
    if not RUN_OPTIMISATION:
        ...
        while i < NUM_TOTAL_EVALUATIONS:
            ...
            model.updateModel(d2SolutionInput[:i,:], -d1HypI_norm, [], [])
